...
Exemplos de features do logback.
--------------------------------
...
- Execute o jconsole em um terminal ou prompt do Windows (JDK 1.6 ou superior).

- Procure pelos MBeans do logback na aba MBeans.
